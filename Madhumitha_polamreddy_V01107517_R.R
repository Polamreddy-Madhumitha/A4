...
survey_df<-read.csv("C:\\Users\\aravi\\Downloads\\Survey.csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df<-read.csv("C:\\Users\\aravi\\Downloads\\Icecream.csv",header=TRUE)
dim(icecream_df)
...
# Load the pizza data
df <- read_csv("C:\\Users\\aravi\\Downloads\\pizza_data.csv")
